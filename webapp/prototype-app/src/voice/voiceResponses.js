...
const LOCALIZED_OVERRIDES = {
  ...
  gu: {
    welcome: "તમે શું કરવા માંગો છો?",
    analyzing: "તમારા આઉટફિટનું વિશ્લેષણ થઈ રહ્યું છે. થોડી સેકન્ડ લાગશે.",
    wardrobeEmpty: "તમારી વૉર્ડરોબ ખાલી છે. શરૂ કરવા માટે પ્રથમ આઇટમ સ્કૅન કરો.",
    noItemToDelete: "તમારી વૉર્ડરોબ ખાલી છે. ડિલીટ કરવા માટે કંઈ નથી.",
    goBack: "પાછળ જઈ રહ્યો છું.",
    error: "કંઈક ખોટું થયું. કૃપા કરીને ફરી પ્રયાસ કરો.",
    shoppingStart: "શૉપિંગ મોડ ચાલુ છે. રીઅલ-ટાઇમ ફીડબૅક માટે કૅમેરો કપડા તરફ રાખો.",
    shoppingPaused: "સ્કૅનિંગ અટકાવ્યું.",
    shoppingResumed: "સ્કૅનિંગ ફરી શરૂ થઈ.",
    wardrobeCount: (n) => `તમારી વૉર્ડરોબમાં ${n} આઇટમ છે.`,
  },
  kn: {
    welcome: "ನೀವು ಏನು ಮಾಡಲು ಬಯಸುತ್ತೀರಿ?",
    analyzing: "ನಿಮ್ಮ ಉಡುಪಿನ ವಿಶ್ಲೇಷಣೆ ನಡೆಯುತ್ತಿದೆ. ಕೆಲವು ಸೆಕೆಂಡ್ಗಳು ತೆಗೆದುಕೊಳ್ಳುತ್ತದೆ.",
    wardrobeEmpty: "ನಿಮ್ಮ ವಾರ್ಡ್‌ರೋಬ್ ಖಾಲಿಯಾಗಿದೆ. ಪ್ರಾರಂಭಿಸಲು ಮೊದಲ ಐಟಂ ಸ್ಕ್ಯಾನ್ ಮಾಡಿ.",
    noItemToDelete: "ನಿಮ್ಮ ವಾರ್ಡ್‌ರೋಬ್ ಖಾಲಿಯಾಗಿದೆ. ಅಳಿಸಲು ಏನೂ ಇಲ್ಲ.",
    goBack: "ಹಿಂದೆ ಹೋಗುತ್ತಿದ್ದೇನೆ.",
    error: "ಏನೋ ತಪ್ಪಾಯಿತು. ದಯವಿಟ್ಟು ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.",
    shoppingStart: "ಶಾಪಿಂಗ್ ಮೋಡ್ ಆನ್ ಆಗಿದೆ. ರಿಯಲ್-ಟೈಮ್ ಫೀಡ್‌ಬ್ಯಾಕ್‌ಗಾಗಿ ಕ್ಯಾಮೆರಾವನ್ನು ಬಟ್ಟೆಯ ಕಡೆ ಹಿಡಿಯಿರಿ.",
    shoppingPaused: "ಸ್ಕ್ಯಾನಿಂಗ್ ನಿಲ್ಲಿಸಲಾಗಿದೆ.",
    shoppingResumed: "ಸ್ಕ್ಯಾನಿಂಗ್ ಮತ್ತೆ ಪ್ರಾರಂಭವಾಗಿದೆ.",
    wardrobeCount: (n) => `ನಿಮ್ಮ ವಾರ್ಡ್‌ರೋಬ್‌ನಲ್ಲಿ ${n} ಐಟಂಗಳಿವೆ.`,
  },
  ml: {
    welcome: "നിങ്ങൾ എന്ത് ചെയ്യാൻ ആഗ്രഹിക്കുന്നു?",
    analyzing: "നിങ്ങളുടെ വസ്ത്രം വിശകലനം ചെയ്യുന്നു. ഏതാനും സെക്കൻഡ് എടുക്കും.",
    wardrobeEmpty: "നിങ്ങളുടെ വാർഡ്‌റോബ് ശൂന്യമാണ്. ആരംഭിക്കാൻ ആദ്യ ഇനം സ്കാൻ ചെയ്യുക.",
    noItemToDelete: "നിങ്ങളുടെ വാർഡ്‌റോബ് ശൂന്യമാണ്. ഇല്ലാതാക്കാൻ ഒന്നുമില്ല.",
    goBack: "തിരിച്ചു പോകുന്നു.",
    error: "എന്തോ തെറ്റ് സംഭവിച്ചു. ദയവായി വീണ്ടും ശ്രമിക്കുക.",
    shoppingStart: "ഷോപ്പിംഗ് മോഡ് ആക്ടീവ് ആണ്. റിയൽ-ടൈം ഫീഡ്‌ബാക്കിനായി ക്യാമറ വസ്ത്രങ്ങളിലേക്ക് ചൂണ്ടുക.",
    shoppingPaused: "സ്കാനിംഗ് നിർത്തി.",
    shoppingResumed: "സ്കാനിംഗ് വീണ്ടും ആരംഭിച്ചു.",
    wardrobeCount: (n) => `നിങ്ങളുടെ വാർഡ്‌റോബിൽ ${n} ഇനങ്ങളുണ്ട്.`,
  },
  pa: {
    welcome: "ਤੁਸੀਂ ਕੀ ਕਰਨਾ ਚਾਹੁੰਦੇ ਹੋ?",
    analyzing: "ਤੁਹਾਡੇ ਆਊਟਫਿੱਟ ਦਾ ਵਿਸ਼ਲੇਸ਼ਣ ਹੋ ਰਿਹਾ ਹੈ। ਕੁਝ ਸਕਿੰਟ ਲੱਗਣਗੇ।",
    wardrobeEmpty: "ਤੁਹਾਡੀ ਵਾਰਡਰੋਬ ਖਾਲੀ ਹੈ। ਸ਼ੁਰੂ ਕਰਨ ਲਈ ਪਹਿਲਾ ਆਈਟਮ ਸਕੈਨ ਕਰੋ।",
    noItemToDelete: "ਤੁਹਾਡੀ ਵਾਰਡਰੋਬ ਖਾਲੀ ਹੈ। ਮਿਟਾਉਣ ਲਈ ਕੁਝ ਨਹੀਂ ਹੈ।",
    goBack: "ਵਾਪਸ ਜਾ ਰਿਹਾ ਹਾਂ।",
    error: "ਕੁਝ ਗਲਤ ਹੋ ਗਿਆ। ਕਿਰਪਾ ਕਰਕੇ ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰੋ।",
    shoppingStart: "ਸ਼ੌਪਿੰਗ ਮੋਡ ਚਾਲੂ ਹੈ। ਰੀਅਲ-ਟਾਈਮ ਫੀਡਬੈਕ ਲਈ ਕੈਮਰਾ ਕੱਪੜਿਆਂ ਵੱਲ ਕਰੋ।",
    shoppingPaused: "ਸਕੈਨਿੰਗ ਰੋਕੀ ਗਈ।",
    shoppingResumed: "ਸਕੈਨਿੰਗ ਦੁਬਾਰਾ ਸ਼ੁਰੂ ਹੋਈ।",
    wardrobeCount: (n) => `ਤੁਹਾਡੀ ਵਾਰਡਰੋਬ ਵਿੱਚ ${n} ਆਈਟਮ ਹਨ।`,
  },
};
